    ...
    <div className='rounded-lg hover:bg-slate-100 cursor-pointer pl-4'>
      <Grid container spacing={4} alignItems="center" className='rounded-lg pb-6 my-4'>
          ...
          <Grid item md={5} className='flex flex-col justify-center' style={{ height: '200px' }}>
            ...
            <span className='flex items-center font-light truncate' style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              <img src='/icon.png' className="mr-4" style={{ width: "10px", height: "15px" }} alt="Location icon" />
              {location}
            </span>
